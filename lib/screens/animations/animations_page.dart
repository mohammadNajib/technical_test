            ...
            BlocConsumer<AnimationsBloc, AnimationsState>(
              ...
              listener: (BuildContext context, AnimationsState state) {
                setState(() {
                  ...
                  radiusAnimation = Tween<double>(begin: radiusAnimation.value, end: currentRadius).animate(controller);
                  currentColor = state.polygons.color;
                  colorAnimation = ColorTween(begin: colorAnimation.value, end: currentColor).animate(colorController);
